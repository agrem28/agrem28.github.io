...
_.first = function(array, num) {
    ...
    var newArray = [];
    for (var i = 0; i < num && i < array.length; i++) {
...
_.last = function(array, num) {
    ...
    var newArray = [];
    for (var i = array.length-1; i > array.length-1-num && i > -1; i--) {
...
_.filter = function(array, action) {
    ...
    _.each(array, function(currentValue, index, array) {
        let result = action(currentValue, index, array);
        if (result) newArray.push(currentValue);
    });
    return newArray;
};
...
_.pluck = function(array, property) {
    return _.map(array, function(e) {return e[property]});
};
...
_.every = function(collection, action) {
    ...
    return !(_.map(collection, action).includes(false));
};
...
_.some = function(collection, action) {
    ...
    return _.map(collection, action).includes(true);
};
